...
namespace Nop.Core.Caching
{
    public interface ILocker
    {
        ...
        /// <param name="heartbeatInterval">The interval at which to update the heartbeat</param>
        ...
        /// <returns>A task that represents requesting cancellation of the task. Note that the completion of this task does <i>not</i>
